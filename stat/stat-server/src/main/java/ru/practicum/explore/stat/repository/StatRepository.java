...
public interface StatRepository extends JpaRepository<Stat, Integer> {
    ...
    List<Stat> findAllByDateTimeIncomeBetweenAndUriIn(LocalDateTime start, LocalDateTime end, List<String> uris);
    ...
    List<ViewStat> getAllStatisticNonUnique(@Param("start") LocalDateTime start, @Param("end") LocalDateTime end,
